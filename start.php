...
function newsletter_init() {
	...
	elgg_register_action("newsletter/admin/newsletter_exporter", dirname(__FILE__) . "/actions/admin/newsletter_exporter.php", "admin");
}
...
function newsletter_pagesetup() {
	...
	// add admin menu item
	elgg_register_admin_menu_item("administer", "newsletter_exporter", "administer_utilities");
}